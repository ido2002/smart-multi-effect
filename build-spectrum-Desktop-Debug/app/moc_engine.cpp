...
void Engine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Engine::*)(QAudio::Mode , QAudio::State );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::stateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Engine::*)(const QString & , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::infoMessage)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Engine::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::errorMessage)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Engine::*)(const QAudioFormat & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::formatChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::bufferLengthChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::dataLengthChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::recordPositionChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::playPositionChanged)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qreal , qreal , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::levelChanged)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 , qint64 , const FrequencySpectrum & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::spectrumChanged)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (Engine::*)(qint64 , qint64 , const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Engine::bufferChanged)) {
                *result = 10;
                return;
            }
        }
